<div class="relative">
    <input x-ref="input-{{$name}}"  class="w-full rounded-md py-1.5 px-2.5 text-sm ring-1 ring-slate-100 focus:ring-2 pr-8" type="text" placeholder="{{$placeholder}}" name="{{$name}}" value="{{$value}}" id="{{$name}}">
